...
public class SemestersPanel  extends JPanel {
	...
	private JButton professors,students,degrees,subjects,rooms,reports,importData,schedule,addNewSemester,editButton,deleteButton,exitButton;
		...
		editButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(selectedIndex!=null && selectedIndex.trim().length()!=0){
					currentGUIFrame.getContentPane().removeAll();
					currentGUIFrame.getContentPane().add(new EditSemesterPanel(currentGUIFrame,selectedIndex));
					currentGUIFrame.getContentPane().repaint();
					selectedIndex="";
				}else{

...
public class ViewSchedulePanel extends JPanel {
	...
	public ViewSchedulePanel(final JFrame currentGUIFrame,ArrayList scheduleList) {
		setLayout(null);		
		...
		lblNewLabel = new JLabel("View Schedules");
		...
		Object columnNames[] = { "Term", "Title", "Meeting Time","Faculty", "Availability"};
		
		if(scheduleList!=null && scheduleList.size()!=0){
			rowData=new String[scheduleList.size()][5];
		...
		exitButton.setBounds(450, 450, 100, 30);

...
public class StudentsPanel extends JPanel {
	...
	private JButton professors,students,degrees,subjects,rooms,reports,importData,schedule,addNewStudent;
	public StudentsPanel(final JFrame currentGUIFrame) {
		...
		Object rowData[][] = { { "Row1-Column1", "Row1-Column2", "Row1-Column3", "Row1-Column4", "Row1-Column5", "Edit", "Delete"},
		                       { "Row2-Column1", "Row2-Column2", "Row2-Column3", "Row1-Column4", "Row1-Column5", "Edit", "Delete"} };

...
public class SemestersPanel  extends JPanel {
	...
	private JButton professors,students,degrees,subjects,rooms,reports,importData,schedule,addNewSemester;
	public SemestersPanel(final JFrame currentGUIFrame) {
		setLayout(null);		
		...
		lblNewLabel = new JLabel("View Semesters");
		...
		addNewSemester = new JButton("Add New Semester");
		addNewSemester.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				currentGUIFrame.getContentPane().removeAll();
				currentGUIFrame.getContentPane().add(new AddSemesterPanel(currentGUIFrame));
				currentGUIFrame.getContentPane().repaint();
			}
		});
		addNewSemester.setBounds(10, 90, 175, 30);
		currentGUIFrame.add(addNewSemester);
		
		Object rowData[][] = { { "Row1-Column1", "Row1-Column2", "Row1-Column3", "Edit", "Delete"},
		                       { "Row2-Column1", "Row2-Column2", "Row2-Column3", "Edit", "Delete"} };
		Object columnNames[] = { "Semester Name", "Start Date", "End Date", "Edit", "Delete"};

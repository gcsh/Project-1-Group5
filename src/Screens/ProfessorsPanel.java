...
public class ProfessorsPanel extends JPanel {
	...
	private JButton professors,students,degrees,subjects,rooms,reports,importData,schedule,addNewProfessor;
	public ProfessorsPanel(final JFrame currentGUIFrame) {
		...
		Object columnNames[] = { "Professor Name", "ID", "Degree", "Hours to Teach", "Credit Hours","Edit", "Delete"};

...
public class ReportsPanel extends JPanel {
	...
	private JButton professors,students,degrees,subjects,rooms,reports,importData,schedule,download;
	public ReportsPanel(final JFrame currentGUIFrame) {
		...
		String	listData[] ={"Schedule","Students","Professors","Subjects","Degree Plans"};
		JList listbox = new JList( listData );
		listbox.setBounds(225, 100, 100, 75);
		...
		download.setBounds(225, 200, 100, 30);

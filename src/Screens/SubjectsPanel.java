...
public class SubjectsPanel extends JPanel {
	...
	private JButton professors,students,degrees,subjects,rooms,reports,importData,schedule,addNewSubjects;
	public SubjectsPanel(final JFrame currentGUIFrame) {
		setLayout(null);		
		...
		lblNewLabel = new JLabel("View Subjects");
		...
		addNewSubjects = new JButton("Add New Subject");
		addNewSubjects.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				currentGUIFrame.getContentPane().removeAll();
				currentGUIFrame.getContentPane().add(new AddSubjectPanel(currentGUIFrame));
				currentGUIFrame.getContentPane().repaint();
			}
		});
		...
		Object rowData[][] = { { "Row1-Column1", "Row1-Column2", "Row1-Column3", "Row1-Column2", "Row1-Column3", "Edit", "Delete"},
		                       { "Row2-Column1", "Row2-Column2", "Row2-Column3", "Row1-Column2", "Row1-Column3", "Edit", "Delete"} };
		Object columnNames[] = { "Subject Id", "Subject Name", "Descrption", "Credit Hours","Class Cap","Edit", "Delete"};
